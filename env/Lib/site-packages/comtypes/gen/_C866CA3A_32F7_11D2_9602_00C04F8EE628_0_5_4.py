...
__all__ = [
    'DISPID_SRCEPhraseStart', 'SpeechCategoryAudioIn',
    'SAFTADPCM_8kHzStereo', 'SITooLoud', 'DISPIDSPTSI_ActiveOffset',
    'ISpStream', 'SPWORDLIST', 'SAFT44kHz16BitStereo',
    'SAFTCCITT_ALaw_22kHzStereo', 'ISpPhrase', 'DISPID_SLWsCount',
    'SLOStatic', 'SpAudioFormat', 'DISPID_SRProfile',
    'SPSHORTCUTPAIRLIST', 'SINoise', 'DISPID_SRRRecoContext',
    'DISPID_SPIRule', 'SPRULESTATE', 'SPINTERFERENCE_NONE',
    'eLEXTYPE_RESERVED4', 'SRCS_Disabled',
    'DISPID_SpeechRecognizerStatus', 'SPRS_ACTIVE', 'SPAS_PAUSE',
    'SpeechVoiceSpeakFlags', 'SPPS_Noncontent',
    'DISPIDSPTSI_SelectionOffset', 'SPPS_Modifier',
    'SPRST_INACTIVE_WITH_PURGE', 'SpeechCategoryRecognizers',
    'SPEI_TTS_AUDIO_LEVEL', 'ISpeechPhraseRule', 'SPCT_SUB_COMMAND',
    'DISPID_SFSClose', 'SP_VISEME_3', 'DISPID_SpeechPhraseProperties',
    'SITooSlow', 'STCInprocHandler', 'SpResourceManager',
    'SPRS_INACTIVE', 'DISPID_SRGetFormat', 'SAFT16kHz16BitMono',
    'SpeechVisemeFeature', 'eLEXTYPE_RESERVED8', 'SVP_18',
    'SRESoundStart', 'DISPID_SRGState', 'SpeechVoicePriority',
    'DISPID_SASFreeBufferSpace', 'SpeechLoadOption',
    'SPEI_REQUEST_UI', 'SpeechRegistryUserRoot', 'SECFEmulateResult',
    'DISPID_SOTMatchesAttributes', 'SpLexicon', 'SVP_14',
    ...
    'SPCT_DICTATION', 'SPWORDPRONUNCIATIONLIST', 'ISpAudio',
    'ISpeechRecoResultDispatch', 'SVP_6',
    'DISPID_SVSLastStreamNumberQueued', 'SPFM_OPEN_READWRITE',
    'ISpeechMemoryStream', 'DISPID_SPRuleEngineConfidence',
    'SpeechAllElements', 'SPRST_INACTIVE', 'SDTPronunciation',
    'DISPID_SVEVoiceChange', 'ISpeechPhraseElement',
    'DISPID_SRCEHypothesis', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPPS_RESERVED3', 'DISPID_SGRSTText',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SVSLastBookmarkId',
    'SGLexical', 'SPEI_MAX_SR', 'DISPID_SPIAudioSizeTime',
    'SSSPTRelativeToCurrentPosition', 'eLEXTYPE_LETTERTOSOUND',
    'SpeechEngineProperties', 'DISPIDSPRG', 'DISPID_SpeechDataKey',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SGRs_NewEnum',
    'SpeechGrammarTagDictation', 'SpeechRecoProfileProperties',
    'SVEViseme', 'SPVPRIORITY', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SpeechPhraseElements', 'DISPID_SREmulateRecognition',
    'SGDSActiveWithAutoPause', 'SVEAllEvents', 'DISPID_SRRTimes',
    'DISPID_SLRemovePronunciation', 'ISpeechRecoResult',
    'STCInprocServer', 'SPWT_PRONUNCIATION', 'SpCustomStream',
    'eWORDTYPE_ADDED', 'SREAdaptation', 'SPSHORTCUTTYPE',
    'SAFTADPCM_44kHzStereo', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SpeechTokenKeyUI',
    'SGDSActiveUserDelimited', 'SPPS_Verb',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SRCVoice',
    'DISPID_SGRSTRule', 'SPEI_PROPERTY_NUM_CHANGE', 'SP_VISEME_8',
    'SRAONone', 'DISPID_SRGSetWordSequenceData', 'SINone',
    'SPWT_LEXICAL', 'SVEVoiceChange', 'DISPID_SRSNumberOfActiveRules',
    'STSF_AppData', 'Speech_StreamPos_Asap', 'DISPID_SOTId',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SpeechXMLRecoResult',
    'ISpStreamFormatConverter', 'SPAUDIOSTATUS', 'DISPID_SPRulesItem',
    'DISPID_SPEAudioSizeTime', 'SpInProcRecoContext',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SVEEnginePrivate',
    'DISPID_SGRsItem', 'DISPID_SLAddPronunciationByPhoneIds',
    'SVP_20', 'DISPID_SpeechGrammarRuleState', 'DISPID_SDKEnumKeys',
    'SPBO_NONE', 'DISPID_SRCRequestedUIType', 'SpeechGrammarState',
    'SVP_21', 'SRARoot', 'DISPID_SRSClsidEngine',
    'SPEI_SR_RETAINEDAUDIO', 'SpStreamFormatConverter',
    'DISPID_SRGSetTextSelection',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpeechRecoResultTimes', 'SpStream', 'SPEI_SOUND_END',
    'DISPID_SPRDisplayAttributes', 'DISPID_SVEStreamEnd',
    'DISPID_SGRSTs_NewEnum', 'ISpeechResourceLoader',
    'ISpeechRecognizerStatus', 'DISPID_SOTDisplayUI', 'SDTProperty',
    'SpeechPropertyAdaptationOn',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SPAStartElementInResult', 'SVEEndInputStream',
    'DISPID_SWFEBlockAlign', 'DISPID_SLWs_NewEnum', 'SPEI_PHONEME',
    'SPPS_Noun', 'ISpeechObjectTokens', 'eLEXTYPE_PRIVATE17',
    'SpMMAudioIn', 'SECFIgnoreKanaType', 'SpeechRuleAttributes',
    'DISPID_SpeechPhraseReplacements', 'eLEXTYPE_PRIVATE20',
    'DISPID_SGRsDynamic', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SPIRetainedSizeBytes', 'SVP_2', 'DISPID_SABIEventBias',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SVEAudioLevel',
    'SpWaveFormatEx', 'DISPID_SGRSRule', 'SAFTNonStandardFormat',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SPAs_NewEnum',
    'DISPID_SVEStreamStart', 'DISPID_SPANumberOfElementsInResult',
    'SRERecognition', 'DISPID_SRCEStartStream', 'ISpLexicon',
    'DISPID_SGRInitialState', 'SAFT11kHz16BitMono', 'SGRSTTRule',
    'DISPID_SVEViseme', 'IInternetSecurityMgrSite',
    'SAFT32kHz8BitStereo', 'DISPID_SBSFormat', 'SAFT12kHz16BitStereo',
    'SPAUDIOOPTIONS', 'DISPID_SLPsItem', 'SAFT22kHz16BitMono',
    'SDTAll', 'eLEXTYPE_PRIVATE7', 'SREPropertyStringChange',
    'SPEI_MIN_SR', 'SpeechCategoryRecoProfiles', 'DISPID_SFSOpen',
    'DISPID_SpeechMemoryStream', 'SREPropertyNumChange',
    'DISPID_SWFEExtraData', 'SWPUnknownWordUnpronounceable',
    'SPEI_RESERVED6', 'eLEXTYPE_PRIVATE5', 'DISPID_SPRules_NewEnum',
    'DISPID_SRRDiscardResultInfo', 'SAFT12kHz16BitMono',
    'DISPID_SRGDictationUnload', 'SpeechVisemeType',
    'DISPID_SPISaveToMemory', 'DISPID_SPPsItem',
    'SpeechDisplayAttributes', 'DISPID_SVAudioOutput',
    '__MIDL_IWinTypes_0009', 'SLTUser', 'ISpeechLexiconWord',
    'SAFTCCITT_uLaw_22kHzStereo', 'SP_VISEME_14', 'SVP_12',
    'DISPID_SPPConfidence', 'DISPID_SVWaitUntilDone',
    'DISPID_SPEEngineConfidence', 'SAFT24kHz16BitStereo',
    'DISPID_SVDisplayUI', 'DISPID_SVVolume', 'SASRun',
    'DISPID_SpeechRecognizer', 'DISPID_SRRSetTextFeedback',
    'eLEXTYPE_PRIVATE16', 'SGRSTTTextBuffer',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SP_VISEME_7',
    'SpPhoneticAlphabetConverter', 'DISPID_SABufferNotifySize',
    'DISPID_SRSAudioStatus', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SPIGrammarId', 'DISPID_SVGetProfiles',
    'DISPID_SRRAudioFormat', 'SPPHRASERULE', 'SpeechAudioState',
    'DISPID_SLWPronunciations', 'DISPID_SOTCGetDataKey',
    'DISPID_SPCPhoneToId', 'DISPID_SRCEEndStream', 'SRSEIsSpeaking',
    'ISpeechPhraseProperty', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SGRAttributes', 'SPXRO_Alternates_SML',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SLWLangId', 'SVP_1',
    'SDTAlternates', 'SpeechWordPronounceable',
    'DISPID_SpeechLexiconWords', 'SP_VISEME_1', 'SRADefaultToActive',
    'DISPID_SDKGetStringValue', 'SPAR_Medium',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SRCSetAdaptationData', 'DISPID_SAFType', 'SPSHORTCUTPAIR',
    'DISPID_SPRNumberOfElements', 'DISPID_SMSGetData',
    'DISPID_SPIGetDisplayAttributes', 'SPSVerb', 'SPPHRASE',
    'SPCT_COMMAND', 'ISpeechLexiconPronunciations',
    'ISpeechRecoContext', 'SBONone', 'eLEXTYPE_RESERVED9',
    '_SPAUDIOSTATE', 'SVP_13', 'SP_VISEME_17', 'SAFT8kHz16BitMono',
    'SPEI_END_SR_STREAM', 'SSSPTRelativeToEnd', 'SVSFParseSsml',
    'SPRECOSTATE', 'SPINTERFERENCE_TOOLOUD', 'ISpXMLRecoResult',
    'SPEI_HYPOTHESIS', 'ISpeechRecoResult2', 'SITooFast',
    'SpeechRuleState', 'SPCONTEXTSTATE', 'SPSTREAMFORMATTYPE',
    'SECFDefault', 'SAFT32kHz16BitStereo',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SPAsItem', 'WAVEFORMATEX',
    'SGSExclusive', 'eLEXTYPE_RESERVED10', 'DISPID_SpeechPhraseInfo',
    ...
    'DISPID_SpeechFileStream', 'SPWORDPRONUNCIATION',
    'DISPID_SpeechRecoContext', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SRGCommit', 'DISPID_SpeechAudioStatus',
    'SECLowConfidence', 'SAFT44kHz16BitMono',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SLPPhoneIds',
    'SSTTWildcard', 'SVEStartInputStream', 'eLEXTYPE_PRIVATE12',
    'SPSHT_EMAIL', 'SAFT22kHz8BitMono', 'DISPID_SRRPhraseInfo',
    ...
    'DISPID_SpeechRecoResult2', 'DISPID_SRGRules', 'SECFIgnoreWidth',
    'SPPROPERTYINFO', 'DISPID_SOTDataKey', 'DISPID_SRCERecognition',
    'SVP_3', 'SFTInput', 'DISPID_SASetState', 'DISPID_SDKEnumValues',
    'SVP_17', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SDTDisplayText', 'SpeechRetainedAudioOptions', 'DISPID_SGRsAdd',
    'SGRSTTEpsilon', 'SPINTERFERENCE', 'DISPID_SpeechLexiconWord',
    'DISPID_SRGRecoContext', 'SVSFIsNotXML', 'SDKLDefaultLocation',
    'DISPID_SASCurrentDevicePosition', 'SPTEXTSELECTIONINFO',
    'SPAO_NONE', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SVGetAudioOutputs', 'DISPID_SCSBaseStream',
    'DISPID_SVSpeakStream', 'DISPID_SOTCSetId', 'SREStreamStart',
    'DISPID_SPACommit', 'DISPID_SRCCreateGrammar',
    'DISPID_SPIEngineId', 'DISPID_SPEActualConfidence',
    'SP_VISEME_19', 'DISPID_SOTCDefault', '_ISpeechRecoContextEvents',
    'DISPID_SpeechGrammarRules', 'ISpeechCustomStream',
    'SpeechTokenIdUserLexicon', 'tagSTATSTG', 'STCAll',
    'SPGS_ENABLED', 'SFTSREngine', 'DISPID_SpeechAudioFormat',
    'DISPID_SpeechGrammarRuleStateTransition', 'SAFT22kHz16BitStereo',
    'SPEVENTENUM', 'SGRSTTWildcard', 'ISpeechWaveFormatEx',
    'SPPS_SuppressWord', 'DISPID_SpeechObjectToken',
    'SAFTGSM610_11kHzMono', 'SVEAudioLevel', 'SVP_9',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SASState',
    'DISPID_SPRuleConfidence', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SRRAlternates', 'SRATopLevel', 'SAFTDefault',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpeechAudioProperties',
    'SGDSActive', 'SpeechAudioFormatGUIDText', 'DISPID_SBSRead',
    'SAFT24kHz16BitMono', 'eLEXTYPE_PRIVATE13', 'SPEI_SOUND_START',
    'SGDSInactive', 'SAFT32kHz16BitMono', 'eLEXTYPE_PRIVATE2',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SPPChildren',
    'SSSPTRelativeToStart', 'ISpObjectWithToken',
    'Speech_StreamPos_RealTime', 'DISPID_SRSetPropertyString',
    'SpeechRecognizerState', 'DISPID_SpeechRecoResult',
    'DISPID_SpeechLexicon', 'ISpMMSysAudio', 'ISpeechLexiconWords',
    'SASPause', 'SVP_8', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SpeechDiscardType', 'eLEXTYPE_PRIVATE18', 'SITooQuiet',
    'DISPID_SVStatus', 'DISPID_SPARecoResult', 'SpInprocRecognizer',
    'SpeechGrammarRuleStateTransitionType', 'SPFM_CREATE',
    'SAFT48kHz8BitStereo', 'SPEI_VISEME',
    'DISPID_SRGCmdSetRuleIdState', 'SPEI_SR_AUDIO_LEVEL', 'SGDisplay',
    'eLEXTYPE_PRIVATE11', 'DISPID_SRIsUISupported',
    'ISpeechGrammarRuleState', 'ISpeechBaseStream', 'SPWF_SRENGINE',
    'DISPID_SGRSTNextState', 'SP_VISEME_12', 'SDKLCurrentUser',
    'SDTRule', 'DISPID_SRCPause', 'SPSEMANTICFORMAT',
    'SAFT12kHz8BitMono', 'DISPID_SABufferInfo', 'SVEBookmark',
    'SRTEmulated', 'DISPID_SRCBookmark', 'ISpRecoResult',
    'ISpGrammarBuilder', 'DISPID_SMSSetData',
    'DISPID_SRCERecognizerStateChange', 'SpeechVoiceEvents',
    'SPEI_RESERVED5', 'ISpRecoCategory', 'ISpeechPhraseReplacements',
    'SP_VISEME_16', 'SREAllEvents', 'DISPID_SVSVisemeId',
    'SPEI_MIN_TTS', 'DISPID_SGRId', 'SVP_7',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SpeechVoice',
    'SRAImport', 'SVSFDefault', 'SWTAdded', 'ISpNotifySource',
    'SPWORD', 'SPFM_CREATE_ALWAYS', 'ISpVoice', 'DISPID_SGRName',
    'ISpEventSink', 'DISPID_SRGId', 'DISPID_SPCIdToPhone',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SOTCId',
    'DISPID_SDKCreateKey', 'SDA_Two_Trailing_Spaces', 'SASClosed',
    'eLEXTYPE_MORPHOLOGY', 'SSTTTextBuffer', 'SPDKL_DefaultLocation',
    'DISPID_SDKDeleteValue', 'SPCT_SUB_DICTATION',
    'SPSHT_NotOverriden', 'SVSFPersistXML', 'DISPID_SGRClear',
    'DISPID_SVVoice', 'DISPID_SLPPartOfSpeech', 'ISpDataKey',
    'DISPID_SRCEBookmark', 'DISPID_SPPNumberOfElements',
    ...
    'DISPID_SAStatus', 'SpFileStream', 'DISPID_SpeechVoiceStatus',
    'SVP_15', 'SPSSuppressWord', 'SpeechAudioFormatType',
    'DISPID_SGRSTPropertyName', 'SP_VISEME_6',
    'SAFTADPCM_22kHzStereo', 'DISPID_SpeechLexiconProns',
    'DISPID_SRCEAudioLevel', 'SASStop', 'DISPID_SRState',
    'DISPID_SWFEAvgBytesPerSec', 'eWORDTYPE_DELETED',
    'SpeechRecoEvents', 'SAFT48kHz8BitMono', 'SPBO_PAUSE',
    'SWPKnownWordPronounceable', 'SAFT12kHz8BitStereo',
    'SECNormalConfidence', 'ISpeechGrammarRuleStateTransition',
    'SRSInactive', 'SREFalseRecognition', 'ISpeechXMLRecoResult',
    'SP_VISEME_15', 'DISPID_SPPName', 'DISPID_SPCLangId',
    'SPLEXICONTYPE', 'DISPID_SWFEFormatTag', 'ISpSerializeState',
    'eLEXTYPE_RESERVED6', 'ISpeechAudioFormat',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRCEventInterests', 'SVP_4',
    'DISPID_SVSPhonemeId', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SRGIsPronounceable', 'SVSFParseMask', 'SSTTDictation',
    'STCRemoteServer', 'SPEI_SR_PRIVATE', 'SPWAVEFORMATTYPE',
    'SpeechAudioVolume', 'DISPID_SRCRetainedAudioFormat',
    'SREBookmark', 'SWPUnknownWordPronounceable',
    'DISPID_SPRulesCount', 'SPFM_NUM_MODES', 'SPVPRI_OVER',
    'SpeechTokenValueCLSID', 'SAFTGSM610_8kHzMono', 'DISPID_SRStatus',
    'SPPS_Unknown', 'DISPID_SRAudioInput', 'ISpResourceManager',
    'DISPID_SDKSetLongValue', 'SPLO_STATIC',
    'DISPID_SDKSetBinaryValue', 'SPAS_CLOSED', 'SPBOOKMARKOPTIONS',
    'SVEPrivate', 'DISPID_SpeechPhoneConverter', 'SVSFlagsAsync',
    'SRAExport', 'SAFT16kHz8BitStereo', 'SVPNormal', 'SVF_Stressed',
    'DISPID_SPRsCount', 'eLEXTYPE_PRIVATE4',
    'DISPID_SVESentenceBoundary', 'SPEVENT',
    'DISPID_SRCEEnginePrivate', 'SpCompressedLexicon',
    'eLEXTYPE_USER', 'eLEXTYPE_APP',
    'SpeechPropertyLowConfidenceThreshold', 'SAFTGSM610_22kHzMono',
    'SAFT11kHz8BitMono', 'ISpEventSource', 'DISPID_SGRSTType',
    'IEnumString', 'eLEXTYPE_PRIVATE3', 'SAFT8kHz8BitStereo',
    'SAFTCCITT_ALaw_22kHzMono', 'SVPAlert', 'SPAUDIOBUFFERINFO',
    ...
    'SpeechPropertyResourceUsage', 'SVSFVoiceMask', 'SRSActiveAlways',
    'SpSharedRecoContext', 'DISPID_SVEPhoneme',
    'SpeechStreamFileMode', 'DISPID_SGRSAddWordTransition',
    'DISPID_SpeechPhraseAlternates', 'SPAS_STOP',
    'SAFT8kHz16BitStereo', 'SPFM_OPEN_READONLY',
    'DISPID_SpeechPhraseReplacement', 'ISpObjectTokenCategory',
    'SPEI_UNDEFINED', 'ISpStreamFormat', 'SVSFParseSapi',
    'SAFTGSM610_44kHzMono', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SRAudioInputStream', 'DISPID_SASCurrentSeekPosition',
    'SpeechLexiconType', 'SAFTADPCM_8kHzMono', 'SPEI_MAX_TTS',
    'DISPID_SpeechPhraseRules', 'ISpeechPhraseAlternates', 'SPRULE',
    'SREStateChange', 'DISPID_SOTSetId', 'SGRSTTWord',
    ...
    'ISpeechDataKey', 'SpeechRecognitionType', 'SPCS_DISABLED',
    'DISPID_SVSLastBookmark', 'SpeechEngineConfidence',
    'SPSERIALIZEDPHRASE', 'SpeechDictationTopicSpelling',
    'SAFT32kHz8BitMono', 'DISPID_SGRSTsItem', 'DISPID_SDKOpenKey',
    'SpObjectToken', 'DISPID_SRCEInterference',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SPPEngineConfidence', 'SpMemoryStream',
    'SpeechEmulationCompareFlags', 'DISPID_SRCRecognizer',
    'SPEI_END_INPUT_STREAM', 'DISPID_SGRSTsCount', 'SPPS_RESERVED4',
    'DISPID_SLAddPronunciation', 'ISpeechAudioBufferInfo',
    'ISpeechLexicon', 'DISPID_SAFSetWaveFormatEx', 'SP_VISEME_4',
    'STSF_FlagCreate', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SLWType', 'eLEXTYPE_PRIVATE8', 'SPGS_EXCLUSIVE',
    'DISPID_SOTsCount', 'DISPID_SRRTTickCount',
    'DISPID_SAFGetWaveFormatEx',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRIsShared', 'DISPID_SRSSupportedLanguages',
    'DISPID_SVEWord', 'SPBINARYGRAMMAR', 'Speech_Default_Weight',
    'DISPID_SVSRunningState', 'DISPID_SVGetAudioInputs', 'SPSUnknown',
    'ISpeechAudioStatus', 'SPPS_LMA', 'SP_VISEME_10',
    'SPBO_TIME_UNITS', 'DISPID_SAFGuid', 'DISPID_SpeechWaveFormatEx',
    'SDTAudio', 'DISPID_SRRTLength', 'DISPID_SWFEChannels',
    'SPXMLRESULTOPTIONS', 'SRTExtendableParse', 'tagSPPROPERTYINFO',
    'SPSFunction', 'SpeechInterference', 'SAFT24kHz8BitMono',
    'DISPID_SRGCmdLoadFromFile',
    'SpeechPropertyHighConfidenceThreshold', 'SSFMOpenForRead',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SPEs_NewEnum',
    'DISPID_SVSpeak', 'DISPID_SRCERequestUI', 'SPRECOGNIZERSTATUS',
    'SpSharedRecognizer', 'SPWF_INPUT', 'DISPID_SGRsCommitAndSave',
    'SPEI_RESERVED1', 'DISPID_SVSInputWordLength', 'SVP_0',
    'UINT_PTR', 'SRADynamic', 'DISPID_SPEsItem',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SOTGetStorageFileName',
    'SVESentenceBoundary', 'DISPID_SpeechMMSysAudio',
    'SpeechSpecialTransitionType', 'ISpeechPhraseInfoBuilder',
    'DISPID_SDKGetlongValue', 'DISPID_SPIReplacements',
    ...
    'DISPID_SMSADeviceId', 'SPGRAMMARSTATE',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPEI_VOICE_CHANGE',
    'DISPID_SRRSpeakAudio', 'SDA_No_Trailing_Space',
    'SDA_One_Trailing_Space', 'SPAR_High', 'DISPID_SVSkip',
    'SP_VISEME_20', 'SPSHT_Unknown', 'SVSFIsFilename',
    'SDKLCurrentConfig', 'DISPID_SVPause',
    ...
    'SAFTCCITT_uLaw_11kHzStereo', 'SRSEDone', 'SPRECORESULTTIMES',
    'ISpPhoneticAlphabetSelection', 'SAFTADPCM_11kHzMono',
    'SREAudioLevel', 'DISPID_SWFEBitsPerSample', 'SP_VISEME_21',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SOTsItem',
    'DISPID_SGRsFindRule', 'DISPID_SPIAudioSizeBytes', 'SPWORDTYPE',
    'SPADAPTATIONRELEVANCE', 'DISPID_SPEDisplayText',
    'DISPID_SOTIsUISupported', 'SVSFNLPMask', 'DISPID_SMSALineId',
    'DISPID_SVAlertBoundary', 'DISPID_SDKDeleteKey', 'ISpProperties',
    'SPDATAKEYLOCATION', 'STSF_CommonAppData',
    'DISPID_SASNonBlockingIO', 'SP_VISEME_18', 'SVP_16',
    'DISPID_SpeechVoiceEvent', 'eLEXTYPE_PRIVATE14',
    'DISPID_SABIBufferSize', 'ISpPhoneticAlphabetConverter',
    'SAFTADPCM_11kHzStereo', 'DISPID_SLWWord', 'SSFMCreate',
    'SRSActive', 'DISPID_SRCESoundStart', 'IEnumSpObjectTokens',
    'SWTDeleted', 'SpeechAudioFormatGUIDWave', 'eLEXTYPE_PRIVATE19',
    'SPDKL_LocalMachine', 'ISpeechLexiconPronunciation', 'SPSLMA',
    'DISPID_SpeechRecoResultTimes', 'SGRSTTDictation',
    'SREPhraseStart', 'DISPID_SOTs_NewEnum', 'SpPhoneConverter',
    'ISpRecognizer2', 'SpUnCompressedLexicon', 'SECFIgnoreCase',
    'DISPID_SPIElements', 'SPDKL_CurrentConfig',
    'SpeechCategoryAppLexicons', 'DISPID_SpeechPhraseElement',
    'ISpRecognizer', 'SVP_10', 'ISpeechVoice',
    'Speech_Max_Word_Length', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SPPFirstElement', 'ISpeechPhraseAlternate', 'SpVoice',
    'SAFT11kHz8BitStereo', 'DISPID_SPRuleId', 'SVSFPurgeBeforeSpeak',
    'DISPID_SVSInputWordPosition', 'eLEXTYPE_RESERVED7',
    'ISpRecognizer3', 'DISPID_SRCESoundEnd', 'DISPID_SOTCategory',
    'ISpeechGrammarRules', 'SP_VISEME_5', 'DISPID_SRRecognizer',
    'SBOPause', 'DISPID_SGRAddState', 'SPRECOCONTEXTSTATUS',
    'SECFNoSpecialChars', 'SpPhraseInfoBuilder', 'SRERequestUI',
    'SPCT_SLEEP', 'ISpeechMMSysAudio', 'DISPID_SVRate',
    'SpeechMicTraining', 'SpeechCategoryAudioOut',
    'DISPID_SpeechObjectTokens', 'DISPID_SPAsCount', 'LONG_PTR',
    'SPAO_RETAIN_AUDIO', 'SPFILEMODE', 'eLEXTYPE_VENDORLEXICON',
    'SPVPRI_ALERT', 'SPPHRASEPROPERTY', 'SPINTERFERENCE_NOISE',
    'SPRST_NUM_STATES', 'DISPID_SVAudioOutputStream',
    'ISpeechGrammarRule', 'SAFTExtendedAudioFormat',
    'SREInterference', 'SVPOver', 'SRSInactiveWithPurge',
    'SPEI_TTS_BOOKMARK', 'SLODynamic', 'eLEXTYPE_PRIVATE6',
    'DISPID_SVEBookmark', 'SpeechFormatType', 'SpMMAudioOut',
    'DISPID_SDKGetBinaryValue', 'SAFTCCITT_ALaw_44kHzMono',
    'SPEI_TTS_PRIVATE', 'ISequentialStream', 'DISPID_SADefaultFormat',
    'ISpeechAudio', 'SINoSignal', 'SPPHRASEREPLACEMENT',
    'eLEXTYPE_PRIVATE1', 'DISPID_SPRText', 'DISPID_SBSWrite',
    'SAFT22kHz8BitStereo', 'DISPID_SAVolume', 'SPXRO_SML',
    'SPSModifier', 'DISPID_SRGDictationLoad',
    'DISPID_SpeechCustomStream', 'SPSNoun', 'DISPID_SOTGetAttribute',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SLPsCount',
    'DISPID_SRCCmdMaxAlternates', 'ISpNotifyTranslator', 'SPAS_RUN',
    'SGSEnabled', 'SRAInterpreter', 'DISPID_SLPSymbolic',
    'DISPID_SPPBRestorePhraseFromMemory', 'SAFT48kHz16BitMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SpeechPhraseProperty', 'DISPID_SpeechAudioBufferInfo',
    'SP_VISEME_9', 'DISPIDSPTSI', 'SpeechCategoryPhoneConverters',
    'DISPID_SLPs_NewEnum', 'SPEI_RESERVED2', 'ISpeechPhraseRules',
    'DISPID_SPRs_NewEnum', 'ISpeechObjectTokenCategory',
    'SP_VISEME_13', 'DISPID_SOTCreateInstance', 'SGSDisabled',
    'SLTApp', 'SPEI_PHRASE_START', 'SREPrivate',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SVPriority',
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpRecoGrammar',
    'DISPID_SPEPronunciation', 'DISPID_SRCCreateResultFromMemory',
    ...
    'SPPS_NotOverriden', 'SRTStandard', 'SpeechGrammarTagWildcard',
    'SpeechTokenContext', 'SpeechTokenKeyFiles', 'IStream',
    'DISPID_SpeechPhraseAlternate', 'SP_VISEME_2',
    'DISPID_SRRTStreamTime', 'SRTReSent',
    'DISPID_SRSetPropertyNumber', 'DISPID_SPILanguageId',
    'DISPID_SLGenerationId',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SpeechPhraseRule', 'DISPID_SRCState', 'DISPID_SBSSeek',
    'SSFMOpenReadWrite', 'SVSFUnusedFlags',
    'DISPID_SVSpeakCompleteEvent', 'SDA_Consume_Leading_Spaces',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SOTCEnumerateTokens',
    'SpeechDataKeyLocation', 'eLEXTYPE_PRIVATE10',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SPIGetText', 'SPRST_ACTIVE',
    'SPLO_DYNAMIC', 'DISPID_SPPId', 'SPVPRI_NORMAL',
    'ISpPhoneConverter', 'DISPID_SLGetPronunciations',
    'SAFT16kHz8BitMono', 'DISPID_SRCEPropertyStringChange',
    'ISpeechPhraseInfo', 'DISPID_SVSLastResult', 'SpShortcut',
    'DISPID_SRGetPropertyNumber', 'SPPS_Function',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SVSInputSentenceLength',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SPRsItem',
    'DISPID_SRDisplayUI', 'SREStreamEnd', 'SVP_19',
    'DISPID_SRCEAdaptation', 'SPGS_DISABLED', 'SpNotifyTranslator',
    'ISpRecoGrammar2', 'DISPID_SPPValue', 'SPCATEGORYTYPE',
    'SRERecoOtherContext', 'SPEI_RECOGNITION', 'DISPID_SRRAudio',
    'SPPHRASEELEMENT', 'SpeechPartOfSpeech', 'SPSERIALIZEDRESULT',
    'SpeechStreamSeekPositionType', 'DISPID_SRGetRecognizers',
    'SPEI_INTERFERENCE', 'SPSNotOverriden', 'SVEWordBoundary',
    'SPCS_ENABLED', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRCRetainedAudio', 'SDKLLocalMachine', '_RemotableHandle',
    'SVSFNLPSpeakPunc', 'ISpeechRecoGrammar', 'SDTLexicalForm',
    'ISpeechRecognizer', 'SAFT8kHz8BitMono', 'SPPARTOFSPEECH',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SABIMinNotification',
    'DISPID_SVResume', 'SpNullPhoneConverter', 'ISpNotifySink',
    'SpeechTokenShellFolder', 'SAFT24kHz8BitStereo',
    'SpeechRegistryLocalMachineRoot', 'SPEVENTSOURCEINFO',
    'DISPID_SpeechGrammarRule', 'ISpeechPhraseReplacement',
    'SPWT_DISPLAY', 'DISPID_SpeechBaseStream',
    'ISpeechPhraseElements', 'DISPID_SLPLangId', 'SPPS_RESERVED1',
    'SVP_11', 'SAFT11kHz16BitStereo', 'DISPID_SPPParent',
    'DISPID_SPRFirstElement', 'ISpRecoContext2', 'ISpeechObjectToken',
    'SpeechRunState', 'SREHypothesis', 'SAFTCCITT_ALaw_11kHzMono',
    'SpeechVoiceSkipTypeSentence', 'SpeechPropertyResponseSpeed',
    'DISPID_SMSAMMHandle', 'DISPID_SRSCurrentStreamPosition',
    'SAFTADPCM_44kHzMono', 'ISpShortcut', 'SPSEMANTICERRORINFO',
    'SAFTTrueSpeech_8kHz1BitMono', 'SRTSMLTimeout',
    'DISPID_SOTGetDescription', 'DISPID_SLGetGenerationChange',
    'SpObjectTokenCategory', 'SPAUDIOSTATE', 'SAFTText',
    'SGPronounciation', 'SRCS_Enabled', 'SDTReplacement',
    ...
    'tagSPTEXTSELECTIONINFO', 'DISPID_SAEventHandle',
    'SpeechBookmarkOptions', 'DISPID_SGRSTWeight',
    'SPPS_Interjection', '_ISpeechVoiceEvents', 'DISPID_SLWsItem',
    'DISPID_SGRSTPropertyValue', 'SVSFParseAutodetect',
    'DISPID_SPIStartTime', 'SPEI_SENTENCE_BOUNDARY', 'ISpRecoContext',
    'DISPID_SOTRemove', 'DISPID_SLPType',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPAR_Low',
    'DISPID_SRGCmdLoadFromObject', 'SECHighConfidence',
    'ISpeechPhoneConverter', 'SPDKL_CurrentUser', 'eLEXTYPE_PRIVATE9',
    'DISPID_SpeechAudio', 'SpeechCategoryVoices', 'DISPID_SRGReset',
    'SpeechTokenKeyAttributes', 'DISPID_SRCResume',
    'DISPID_SPIProperties', 'DISPID_SPRuleParent',
    'DISPID_SRGDictationSetState', 'SPSInterjection',
    'SAFT16kHz16BitStereo', 'DISPID_SPRuleName', 'SPEI_ADAPTATION',
    'SVSFIsXML', 'DISPID_SPELexicalForm', 'DISPID_SGRAddResource',
    'DISPID_SDKSetStringValue', 'DISPID_SPRuleChildren',
    'DISPID_SVGetVoices', 'SPVISEMES', 'DISPID_SLGetWords',
    'ISpeechTextSelectionInformation', 'eLEXTYPE_PRIVATE15',
    'SPBO_AHEAD', 'SPEI_START_SR_STREAM', 'SP_VISEME_11',
    'ISpeechVoiceStatus', 'SPGRAMMARWORDTYPE', 'ISpObjectToken',
    'SPEI_SR_BOOKMARK', 'SRAORetainAudio', 'STCLocalServer',
    'SVEPhoneme', 'SAFTADPCM_22kHzMono', 'DISPID_SGRsCount',
    'SpeechWordType', 'SPPS_RESERVED2', 'SPEI_WORD_BOUNDARY', 'SVP_5',
    'SAFT44kHz8BitStereo', 'IInternetSecurityManager',
    'DISPID_SGRsCommit', 'SRESoundEnd', 'SGLexicalNoSpecialChars',
    'SPVOICESTATUS', 'ISpeechPhraseProperties', 'SPWORDPRONOUNCEABLE',
    'DISPID_SRCreateRecoContext', 'DISPID_SRRSaveToMemory',
    'SPSMF_UPS'
]

_check_version('1.2.1', 1700383517.163670)
